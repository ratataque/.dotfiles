...
bind_exec(mainMod .. " + R", "kitty -e tmux -u")
bind_exec("SUPER + SHIFT + R", "kitty")
bind_exec(mainMod .. " + E", "footclient yazi")
bind_exec(mainMod .. " + W", "kitty -e ~/.config/sesh/sesh.sh")
bind_exec(mainMod .. " + C", "QT_QPA_PLATFORM=wayland QT_SCALE_FACTOR=1 qalculate-qt")
bind_exec(mainMod .. " + B", "footclient bluetui")
bind_exec(mainMod .. " + Z", "footclient wifitui")
bind_exec(mainMod .. " + COMMA", "footclient pulsemixer")
...
-- System controls
bind_exec(mainMod .. " + X", "wlogout --protocol layer-shell")
bind_exec("SUPER + SHIFT + B", "killall waybar; waybar")

-- Utilities
bind_exec(mainMod .. " + P", "1password --quick-access")
